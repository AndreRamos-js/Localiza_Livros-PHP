...
<body>
    ...
    <p><a href="cadastro-cliente.php">Cadastrar Novo Cliente</a></p>
        ...
        <table border="1">
            ...
            <?php foreach ($clientes as $cliente) : ?>
                <tr>
                    ...
                    <td>
                        <a href="editar-cliente.php?id=<?php echo $cliente['id']; ?>">Editar</a>
                        <form action="../../../biblioteca/actions/cliente/processa-deletar-cliente.php" method="post" style="display: inline-block;">
                            ...
                            <button type="submit" onclick="return confirm('Tem certeza que deseja deletar o cliente <?php echo $cliente['nome_completo']; ?>?')">Deletar</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
